...
<html>
  ...
  <body>
    ...
    <span style="margin-left: 750px;color:white">
      <a href="crud/create.php">Buat Resep</a>
    </span>
    <span style="margin-left: 20px;color:white">
      <a href="crud/edit.php">Edit Resep</a>
    </span>
    <span style="margin-left: 20px;color:white">
      <a href="crud/delete.php">Hapus Resep</a>
    </span>
    <span style="margin-left: 20px;color:white">
    ...
    <form name="search"action="" method="POST">
     ...
     <table id="t" style="color:white">
      <tr>
        <td class="content"><a style="text-decoration:none;" href = "food recipe/pizza.html"><button>Pizza</button></a></td>
        <td class="content"><a style="text-decoration:none;" href = "food recipe/pasta.html"><button>Pasta</button></a></td>
